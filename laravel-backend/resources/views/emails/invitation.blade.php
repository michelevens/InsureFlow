                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:0 0 16px 16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                                ...
                                <tr>
                                    <td style="padding:24px 48px 40px;">
                                        ...
                                        <p style="margin:0 0 24px;color:#64748b;font-size:15px;text-align:center;line-height:1.5;">{{ $inviterName }} has invited you to join <strong style="color:#134e4a;">{{ $agencyName }}</strong> on InsureFlow as a <strong style="color:#134e4a;">{{ $role }}</strong>.</p>

                                        <!-- CTA -->
                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="background-color:#0f766e;border-radius:12px;">
                                                    <a href="{{ $inviteUrl }}" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">Accept Invitation</a>
                                                </td>
                                            </tr>
                                        </table>

                                        <p style="margin:24px 0 0;color:#94a3b8;font-size:13px;text-align:center;line-height:1.5;">This invitation expires in 7 days.</p>
                                    </td>
                                </tr>
