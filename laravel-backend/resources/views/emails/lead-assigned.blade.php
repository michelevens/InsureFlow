                                        ...
                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="background-color:#0f766e;border-radius:12px;">
                                                    <a href="{{ env('FRONTEND_URL', 'https://insurons.com') }}/portal/leads" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">View Lead</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
