        ...
        <tr>
            <td align="center">
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;">
                    <!-- Top accent bar -->
                    <tr>
                        <td style="height:6px;background:linear-gradient(90deg,#dc2626,#f59e0b,#0ea5e9);border-radius:12px 12px 0 0;"></td>
                    </tr>
                    <tr>
                        <td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="background-color:#dc2626;border-radius:12px;">
                                                    <a href="{{ env('FRONTEND_URL', 'https://insurons.com') }}/crm/leads" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">Review Lead</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
