                                        ...
                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="background-color:#0f766e;border-radius:12px;">
                                                    <a href="{{ env('FRONTEND_URL', 'https://insureflow.com') }}/calculator" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">View Your Quotes</a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="border:2px solid #14b8a6;border-radius:12px;">
                                                    <a href="{{ env('FRONTEND_URL', 'https://insureflow.com') }}/register" style="display:inline-block;padding:12px 28px;color:#0f766e;text-decoration:none;font-size:14px;font-weight:600;">Create Free Account</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
