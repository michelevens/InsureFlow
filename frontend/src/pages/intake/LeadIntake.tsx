    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-4">This intake link is no longer active or does not exist.</p>
          <Link to="/" className="text-shield-600 dark:text-shield-400 hover:underline text-sm">Go to InsureFlow</Link>
        </Card>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-300 mb-1">Your information has been submitted successfully.</p>
          <p className="text-slate-500 dark:text-slate-400 text-sm">A licensed agent from <span className="font-semibold">{agencyName}</span> will contact you shortly.</p>
        </Card>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-4">
      <Card className="max-w-lg w-full p-8">
        <div className="text-center mb-6">
          <ShieldCheck className="w-10 h-10 text-shield-600 dark:text-shield-400 mx-auto mb-3" />
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">{agencyName}</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Tell us about your insurance needs and we'll be in touch.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-slate-700 dark:text-slate-200">When do you need coverage?</label>
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 text-center">
            Powered by <a href="/" className="text-shield-600 dark:text-shield-400 hover:underline">InsureFlow</a>
          </p>
        </form>
      </Card>
    </div>
