  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">Configure SAML 2.0 single sign-on for enterprise agencies</p>
      </div>
      ...
      {agencies.length > 1 && (
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/50 p-6">
          <label className="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">Select Agency</label>
          <select
            ...
            className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700/50 focus:ring-2 focus:ring-shield-500 dark:focus:ring-shield-400 focus:border-transparent"
          >
        ...
        <>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/50 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Service Provider Details</h2>
            </div>
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">SP Entity ID / Metadata URL</label>
                <div className="flex gap-2">
                  <code className="flex-1 px-3 py-2 bg-slate-50 dark:bg-slate-800 rounded-lg text-sm text-slate-700 dark:text-slate-200 break-all">
                    {metadataUrl}
                  </code>
                  <button onClick={() => copyToClipboard(metadataUrl)} className="p-2 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:text-slate-300">
                    <Copy className="w-4 h-4" />
                  </button>
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">ACS URL (Assertion Consumer Service)</label>
                <div className="flex gap-2">
                  <code className="flex-1 px-3 py-2 bg-slate-50 dark:bg-slate-800 rounded-lg text-sm text-slate-700 dark:text-slate-200 break-all">
                    {acsUrl}
                  </code>
                  <button onClick={() => copyToClipboard(acsUrl)} className="p-2 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:text-slate-300">
                    <Copy className="w-4 h-4" />
                  </button>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/50 p-6">
            <div className="flex items-center gap-2 mb-4">
              <Key className="w-5 h-5 text-shield-600 dark:text-shield-400" />
              <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Identity Provider Settings</h2>
            </div>
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700/50 focus:ring-2 focus:ring-shield-500 dark:focus:ring-shield-400 focus:border-transparent text-sm font-mono resize-none"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-1.5">
            ...
            <div className="flex items-center gap-3 mt-6 pt-4 border-t border-slate-100 dark:border-slate-700/50">
          ...
          {/* SSO Login URL */}
          {selectedAgency.sso_enabled && (
            <div className="bg-green-50 dark:bg-green-900/30 rounded-2xl border border-green-200 p-6">
              ...
              <div className="flex gap-2">
                <code className="flex-1 px-3 py-2 bg-white dark:bg-slate-900 rounded-lg text-sm text-green-800 break-all">
                ...
                <button
                  ...
                  className="p-2 text-green-500 hover:text-green-700 dark:text-green-300"
                >
                  <Copy className="w-4 h-4" />
                </button>
              </div>
