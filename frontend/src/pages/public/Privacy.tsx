      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-12 h-12 rounded-xl bg-shield-50 dark:bg-shield-900/30 flex items-center justify-center">
            <Shield className="w-6 h-6 text-shield-600 dark:text-shield-400" />
          </div>
          <div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/50 p-8 lg:p-10 space-y-8 text-sm text-slate-700 dark:text-slate-200 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-3">4. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-3">5. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-3">6. Your Rights and Choices</h2>
            ...
            <p className="mt-2">To exercise these rights, contact us at <a href="mailto:privacy@insurons.com" className="text-shield-600 dark:text-shield-400 hover:underline">privacy@insurons.com</a>.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-3">7. Cookies and Tracking</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-3">10. Contact Us</h2>
            <p>If you have questions about this Privacy Policy, please contact us at:</p>
            <div className="mt-2 bg-slate-50 dark:bg-slate-800 rounded-xl p-4">
              <p className="font-medium text-slate-900 dark:text-white">Insurons Privacy Team</p>
              <p>Email: <a href="mailto:privacy@insurons.com" className="text-shield-600 dark:text-shield-400 hover:underline">privacy@insurons.com</a></p>
            </div>
          </section>
        </div>
        ...
        <div className="flex items-center justify-center gap-6 mt-8 text-sm text-slate-500 dark:text-slate-400">
          <Link to="/terms" className="hover:text-shield-600 dark:text-shield-400">Terms of Service</Link>
          <span>|</span>
